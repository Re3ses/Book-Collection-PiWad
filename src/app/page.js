        ...
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <div className="md:w-1/3 w-full">
            <form
              ...
              className={`shadow-md rounded-xl px-6 py-8 border border-gray-200 ${editId ? 'bg-green-50' : 'bg-white'
                }`}
            >
          ...
          <div className="md:w-2/3 w-full flex flex-col gap-6">
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              <button
                ...
                className={`text-white px-3 py-1 rounded-lg ${selectedIds.length === 0
                ...
                <tbody>
                  {pagedBooks.length === 0 ? (
                    ...
                    pagedBooks.map((b) => (
                      <tr
                        key={b.id}
                        className={`hover:bg-gray-50 ${isOverdue(b.dueDate)
                            ? 'bg-red-50'
                            : b.status === 'Borrowed'
                              ? 'bg-yellow-50'
                              : ''
...
function SortArrow({ direction }) {
  return (
    <svg
      className={`inline w-4 h-4 ml-1 ${direction === 'asc' ? 'rotate-180' : ''
        }`}
      fill="none"
      stroke="currentColor"
      strokeWidth={2}
